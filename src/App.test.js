...
test('test that App component renders Task', () => {
  ...
  fireEvent.change(taskInput.querySelector('input'), { target: { value: 'Calculus Test' } });

  waitFor(() => {
    expect(taskInput.value).toBe("Calculus Test");
  });

  fireEvent.click(addButton);

  waitFor(() => {
    const taskTextElement = screen.getByText(/Calculus Test/i);
...
test('test that App component renders Task', () => {
  ...
  waitFor(() => {
    const taskTextElement = screen.getAllByText(/Calculus Test/i);
